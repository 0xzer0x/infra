...
pkgs.writeShellScriptBin "audioctl" ''
  ...
  declare -A __MUTE_ICONS=(
    [@DEFAULT_SINK@]=${pkgs.papirus-icon-theme.outPath}/share/icons/Papirus-Dark/24x24/actions/audio-volume-muted.svg
    [@DEFAULT_SOURCE@]=${pkgs.papirus-icon-theme.outPath}/share/icons/Papirus-Dark/24x24/symbolic/status/audio-input-microphone-muted-symbolic.svg
  )

  declare -A __ACTIVE_ICONS=(
    [@DEFAULT_SINK@]=${pkgs.papirus-icon-theme.outPath}/share/icons/Papirus-Dark/24x24/actions/audio-volume-high.svg
    [@DEFAULT_SOURCE@]=${pkgs.papirus-icon-theme.outPath}/share/icons/Papirus-Dark/24x24/symbolic/status/audio-input-microphone-high-symbolic.svg
  )
